 ...
 *
 * The `contributions` field tracks total contributions for informational display,
 * but does not change AU tax treatment (unlike Roth, all IRA funds are pre-tax).
 */
export class TraditionalIRAAccount extends RetirementAccount {
  ...
  getUSAccountTreatment(eventType, amount, context = {}) {
    if (eventType === 'contribution') return { taxableIncome: 0,      penaltyAmount: 0, note: 'Pre-tax contribution (deductible IRA assumed)' };
